...
function joinClassName(...classnames: string[]) {
        ...
        <div className='mt-8'>
          <div className='relative'>
            ...
            <div className=' relative -top-3 text-center'>
              <span className='bg-white px-2 text-sm font-medium text-gray-500'>Or enter with</span>
            </div>
          </div>

          {/* Social Login Button */}
          <div className='mt-2 grid grid-cols-2 gap-3'>
            <button className='hover: flex items-center justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 text-black shadow-sm    hover:bg-gray-50'>
              <svg className='h-5 w-5' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20'>
                <path d='M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84' />
              </svg>
            </button>
            <button className='flex items-center justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50 hover:text-black'>
              <svg className='h-5 w-5' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20'>
                <path
                  fillRule='evenodd'
